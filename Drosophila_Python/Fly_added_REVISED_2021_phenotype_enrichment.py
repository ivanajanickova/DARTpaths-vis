...
C_ele_ENSEMBL_orthology_database = path_to_databases+"/2020_Oct_downloaded/"+"Orthology_human_celegans_ensembl101_unique.txt"
Zebrafish_ENSEMBL_orthology_database = path_to_databases+"/2020_Oct_downloaded/"+"Orthology_human_zebrafish_ensembl101_unique.txt"
Mouse_ENSEMBL_orthology_database = path_to_databases+"/2020_Oct_downloaded/"+"Orthology_human_mouse_ensembl101_unique.txt"
Slime_mould_ENSEMBL_orthology_database = path_to_databases+"/2020_Oct_downloaded/"+"Orthology_human_dicty_ensembl101_unique.txt"
Fly_ENSEMBL_orthology_database = path_to_databases+"/2020_Oct_downloaded/"+"Orthology_human_dmelanogaster_ensembl101_unique.txt"

### Phenotype databases for each species ####

C_ele_phenotype_database = path_to_phenotype_database_folder+"/"+"phenotype_association.WS264.wb"
Zebrafish_phenotype_database = path_to_phenotype_database_folder+"/"+"phenoGeneCleanData_fish_2020.09.25.txt"
Mouse_phenotype_database = path_to_phenotype_database_folder+"/"+"ALL_genotype_phenotype.csv"
Slime_mould_phenotype_database = path_to_phenotype_database_folder+"/"+"all-mutants-ddb_g.txt"

Fly_gene_to_allele_database = path_to_phenotype_database_folder+"/"+"Fly_fbal_to_fbgn_fb_FB2021_01.tsv"
Fly_allele_to_phenotype_database = path_to_phenotype_database_folder+"/"+"Fly_allele_phenotypic_data_fb_2021_01.tsv"
...
Fly_ontology_data_file = path_to_ontology_database_folder+"/"+"Fly_go-basic.obo"
...
def Phenotypes(organism):
  ...
  if organism == "celegans":
    ...
    phzfish = pd.read_csv(Zebrafish_phenotype_database, skiprows=1,delimiter='\t',header='infer')
...
#    Q= 10 ###### Random test. correct one is Q=0.001
