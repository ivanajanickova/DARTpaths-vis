  ...
  if organism == "celegans":
    ...
    if my_file.exists():
        ...
        if filetime < days_pass:
            ...
            fly_gz_file = wget.download('http://ftp.flybase.org/releases/current/precomputed_files/alleles/fbal_to_fbgn_fb_FB2021_02.tsv.gz', out=path_to_phenotype_folder)
    ...
    if my_file.exists():
        ...
        if filetime < days_pass:
            ...
            fly_gz_file = wget.download('http://ftp.flybase.org/releases/current/precomputed_files/alleles/allele_phenotypic_data_fb_2021_02.tsv.gz', out=path_to_phenotype_folder)
            with gzip.open(fly_gz_file, 'rb') as f_in:
